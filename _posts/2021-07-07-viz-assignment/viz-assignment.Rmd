...
### ADD IN DROP DOWN MENU / at least make sure the time is not overlapped
...
## right join?
# cc_loc3 <- right_join(cc_loc2, sf_mpsz2,
#                      by = c("fetype" = "FETYPE",
#                             "street" = "FENAME",
#                             "dir" = "FEDIRP",
#                             "num_round" = "FROM"),
...
shapeData <- st_transform(sf_mpsz, '+proj=longlat +datum=WGS84')
