...
![Figure 4.3.3: Filtering Variables](img/tabviz1_3.png){width=50%}

![Figure 4.3.4: Filtering Timeline](img/tabviz1_3.2.png){width=50%}

</center>

4. Next, we will change the graph into a bar chart by selecting it from the _"Marks"_ pane. We will also change the formatting for "Date" from the drop down by clicking on the "+" sign next to "Date" again to display the quarters as well. Hence, the steps and plot becomes like this: 

<center>

![Figure 4.3.5: Bar Chart](img/tabviz1_4.1.png){width=60%} 

![Figure 4.3.5: Altering the timeline](img/tabviz1_4.2.png){width=60%} 

![Figure 4.3.5: Output of Bar Chart after changes to timeline](img/tabviz1_4.3.png){width=60%} 
...
![Figure 4.3.6: Creating calculated field](img/tabviz1_5.1.1.png){width=50%}

![Figure 4.3.7: Formula used in the calculated field](img/tabviz1_5.1.png) 

![Figure 4.3.8: Output after manipulation - Vertical Diverging Graph](img/tabviz1_5.2.png)
...
![Figure 4.3.9: Creating Dual Axis with Line Graph #1](img/tabviz1_6.1.png) 

![Figure 4.3.10: Creating Dual Axis with Line Graph #2](img/tabviz1_6.2.png){width=50%} 

![Figure 4.3.11: Creating Dual Axis with Line Graph #3](img/tabviz1_6.3.png){width=50%} 

![Figure 4.3.12: Creating Dual Axis with Line Graph #4](img/tabviz1_6.4.png){width=50%} 

![Figure 4.3.12: Output of Line and Bar Graphs together on same axis](img/tabviz1_6.5.png)
...
2. Change the colours of the bar chart to colours that are more pleasing to the eye.
    + Add in differentiating colours for negative and positive values in the trade balance by dragging "Balance" to _"Color"_ in the Marks pane. Edit the colors into 2 steps that centered at 0, as shown below:

<center>

![Figure 4.3.13: Creating 2-stepped color](img/tabviz1_7.1.png){width=50%}
...
3. Changing the labels on the axis to positive values:
    ...
    + Under the _"Axis"_ section, select the _"Numbers"_, click _"Custom"_ and enter the format as shown below: 
    
<center>

![Figure 4.3.14: Reformatting axis to become all positive](img/tabviz1_7.2.png){width=50%}
...
![Figure 4.3.15: Final Output of First Chart](img/Trade Volume and Balance.png)
...
1. Open up an empty sheet and drag in "Country", "Date" to columns while "Type" into the rows. Leave the dates as yearly values.
...
![Figure 4.4.1: Changing chart type to Highlighted Table](img/tabviz2_1.png){width=50%}
...
![Figure 4.4.5: Addition of Subtotals and Grand Totals to the Table](img/tabviz2_5.png){width=50%}

</center>


3. Rename the axes and title of the chart for better understanding. After all the steps above, the final chart is shown below:

![Figure 4.4.6 Net Trade Volume](img/Net Trade Volume.png)
...
![Figure 4.5.1: Empty New Dashboard page](img/tabviz3_1.png){width=55%}

![Figure 4.5.2: Setting the size of Dashboard](img/tabviz3_2.png){width=40%}

</center>


2. Drag in both sheets into the empty dashboard. Make sure to format the layout of all the charts as well as the legends and text into _"Floating"_. This will allow to resize and reorganize our dashboard easily.
...
![Figure 5.1: Singapore Merchandise Trade with Top Six Countries, 2019-2020](img/Dashboard 1.png)
