...
1. From the graphs, we noticed that the main exporter/importer for Singapore's Merchandise Trade in 2019-2020 is **Mainland China**. The net calculations of trade volume between each year shows that **America** has the steepest _decline in import trades_, while **Malaysia** has the _steepest decline for export trades_.
