...
S/N | Description 
----| ---------
1 | ![](img/tabprep_connectDataMerged.png){#id .class height=45%} <br/>Click on _"Connect data"_, followed by _"Microsoft Excel"_ to upload the raw dataset.
...
Repeat the same steps as above for the Export Table. For easier reference, we shall combine both Imports.xlsx and Exports.xlsx into one excel sheet before uploading into **Tableau Desktop**.
