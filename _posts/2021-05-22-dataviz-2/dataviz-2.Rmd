...
5. Next, we will add in an info icon that will display information when hovered. This is not only interactive feature, but also due to dashboard constraints, we can add in more information via the hover function.
