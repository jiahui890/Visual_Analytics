...
Annnnnnnnnnd now our first chart is done! After a few finishing touches (hiding the top axis, renaming chart title, sort in descending), our final static diverging lollipop graph will look like this:


![Figure 4.3.14: Final Static Lollipop Graph for Net Trade Value](img/Net Trade Value.png)
...
![Figure 4.4.4: Final Static Bar and Line Graph](img/Trade Value.png)
