...
5. Next, we will add in an info icon that will display information when hovered. This is not only an interactive feature, but also due to dashboard constraints, we can add in more information via the hover function.
    ...
    + Hence, the **final** format for this icon should look something like in Fig 4.5.8.
...
6. Finally, let's input this hover icon into the dashboard.
