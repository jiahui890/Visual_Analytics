...
words <- c("Import the raw dataset into Tableau Desktop. From there, we can see 2 different tables - T1 and T2.", "Click on _New Union_ and drag both T1 and T2 and select _Apply_.","The data table will be stacked and it should look something like this:")
imgs <- c("img/4.2.1.png","img/4.2.2.png","img/4.2.3.png")
